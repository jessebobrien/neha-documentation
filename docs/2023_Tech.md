...
5. Eye Protection
	...
	4. Polycarbonate (Lexan) may be used where permitted as an alternatewindshield or window. Acrylic (Plexiglass) is not acceptable.
...
1. Suspension
	...
	3. Steering: no loose tie rods, pitman arms, idler arms, or rack ends. Limited free play; steering wheel in good condition, tight column. If a quick-disconnect steering wheel coupler is used, it must be made of metal, with no plastic inserts.
...
A. Competitors wishing to race a Prepared Electric Vehicle (class PE) must contact the event organizer or a technical committee member prior to
...
H. Audio Warning – An audible warning system is required, generating between 80 and 90 decibels of sound when measured 50 feet from the vehicle.
